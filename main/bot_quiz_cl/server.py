...
from bot import welcome_message
import logging
...
def webex_teams_webhook_events():
    ...
    if request.method == 'GET':
        ...
        return quiz_bot_process_message(api,config,request.json,psql_obj)

@flask_app.route('/memberships', methods=['GET', 'POST'])
def webex_teams_webhook_memberships():
    """Processes incoming requests to the '/memberships' URI."""
    if request.method == 'GET':
        return ("""<!DOCTYPE html>
                   <html lang="en">
                       <head>
        ...
        return welcome_message(api,config,request.json)
